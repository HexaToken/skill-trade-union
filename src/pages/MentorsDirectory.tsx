...
const MentorsDirectory = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#0F172A]">
      ...
      <div className="sticky top-0 z-40 !bg-white dark:!bg-[#0F172A] backdrop-blur-sm border-b border-[#E2E8F0] dark:border-[#334155]" style={{backgroundColor: 'white !important'}}>
