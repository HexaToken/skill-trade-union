    ...
    <div className="page-container section-spacing">
      <div className="space-y-8">
        ...
        <div className="grid gap-4 md:grid-cols-4">
          <Card className="glass-card hover-lift border-brand-amber/20">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Credits Balance</CardTitle>
              <Zap className="h-4 w-4 text-brand-amber" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-brand-amber">{stats.credits}</div>
          ...
          <Card className="glass-card hover-lift border-brand-secondary/20">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-brand-secondary">{stats.sessionsThisMonth}</div>
          ...
          <Card className="glass-card hover-lift border-brand-amber/20">
            ...
            <CardContent>
              <div className="flex items-center gap-2 mb-1">
                <span className="text-2xl font-bold text-brand-amber">{stats.rating}</span>
