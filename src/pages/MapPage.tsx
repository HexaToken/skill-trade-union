        ...
        <div className="page-container py-4">
          <div className="flex flex-wrap items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              />
              <Label htmlFor="heatmap" className="flex items-center gap-2 text-sm">
      ...
      <div className="flex h-[calc(100vh-300px)] relative">
        ...
        <div className="flex-1 relative bg-muted/30">
          ...
          {selectedMarker && (
            ...
            >
              <Card className="w-80 shadow-xl border-2 border-brand-primary/20 bg-white/95 backdrop-blur">
        ...
        {/* Side Panel */}
        <div className={cn(
          "w-96 border-l bg-card transition-all duration-300 overflow-hidden",
              ...
              <TabsContent value="challenges" className="px-4 pb-4 space-y-4">
                <div className="space-y-3">
                  {mapData.challenges.map((challenge) => (
                    <div key={challenge.id} className="p-3 bg-muted/50 rounded-lg hover:bg-muted cursor-pointer">
