...
export default function MapPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Hero Section */}
      <div
        className="relative bg-gradient-to-br from-primary via-primary/90 to-secondary bg-cover bg-center"
        style={{
          ...
          <div className="max-w-4xl">
            ...
            <div className="relative max-w-2xl">
              ...
              <Input
                ...
                className="pl-12 h-12 md:h-14 text-base md:text-lg bg-white/98 dark:bg-slate-800/98 backdrop-blur border-border dark:border-white/30 placeholder:text-ink-body/50 dark:placeholder:text-white/50 shadow-lg"
              />
            </div>
          </div>
        </div>
      ...
      <div className="flex md:h-[calc(100vh-300px)] h-[calc(100vh-200px)] relative">
        ...
        <div className={cn(
          "hidden md:block w-96 border-l border-border bg-white/95 dark:bg-slate-900/95 backdrop-blur transition-all duration-300 overflow-hidden",
          sidePanelOpen ? "translate-x-0" : "translate-x-full w-0"
        )}>
          <div className="h-full overflow-y-auto">
            {/* Panel Header */}
            <div className="p-4 border-b border-border bg-gray-50/80 dark:bg-slate-800/80">
              <div className="flex items-center justify-between">
              ...
              <TabsContent value="trending" className="px-4 pb-4 space-y-4">
                <div className="space-y-3">
                  {mapData.trendingSkills.map((skill, index) => (
                    <div key={index} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-slate-800 rounded-lg hover:bg-gray-100 dark:hover:bg-slate-700 cursor-pointer border border-gray-100 dark:border-slate-600">
                      <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-3">
                {mapData.fastestGrowingSkills.map((skill, index) => (
                  <div
                    key={index}
                    className="flex items-center gap-2 bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-600 rounded-full px-4 py-2 hover:shadow-md transition-all cursor-pointer"
                  >
